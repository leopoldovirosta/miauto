...
mostrarCabecera("Selecciona tu vehiculo para ver los repostajes");
navUser();
?>
<div class="container">
  <div class="row">
    <form class="form-horizontal" action="ver_repostajes.php" method="get">
        <div class="col-sm-6">
            ...
            <div class="col-sm-3">
                ...
                <select name="id_vehiculo" id="inputWarning" size="1">
