...
mostrarCabecera("Bienvenido al área de usuarios " . $_SESSION["usuario"] );
navUser();
?>
            ...
            <div class="panel-group" id="accordion">
                <div class="panel panel-default">
                  ...
                  <div id="collapse1" class="panel-collapse collapse in">
                      <div class="panel-body">Nuestra base de datos cuenta con los <a href="ver_modelos.php">modelos</a> que han ido registrando los usuarios, si tu modelo no se encuentra entre ellos puedes usar el <a href="registro_modelo.php">formulario de registro</a> y darlo de alta. Cada modelo cuenta con su propia ficha y los datos más relevantes.</div>
                  </div>
                </div>
                <div class="panel panel-default">
                  ...
                  <div id="collapse2" class="panel-collapse collapse">
                    <div class="panel-body">Identifica tu modelo o crealo en caso de no existir, <a href="registro_mi_auto.php">asignalo a tu usuario</a> y empieza a ingresar tus repostajes. Puedes añadir uno o más <a href="ver_mis_autos.php">vehículos</a> a tu cuenta personal.</div>
                  </div>
                </div>
                <div class="panel panel-default">
                  ...
                  <div id="collapse3" class="panel-collapse collapse">
                    <div class="panel-body">En nuestra base de datos podrás <a href="registro_repostaje_previo.php">añadir</a> todos los repostajes de tu vehículo, para poder controlar los <a href="ver_repostajes_previo.php">consumos</a> de tu auto.</div>
                  </div>
                </div>
            </div>
        </div>
